(function() {
  ...
  app.menu = menu = {
    ...
    show: function() {
      return classie.add(html, "app-show-menu");
    },
    hide: function() {
      return classie.remove(html, "app-show-menu");
    }
  };
  scrollPrev = 0;
    ...
    */
    ...
    window.requestAnimationFrame(function() {
      if (scrollDirection === "up") {
        ...
        classie.add(html, "scrolled-down");
        return classie.remove(html, "scrolled-up");
      }
    });
    return scrollPrev = scroll;
  };
  return setupWayPoints = function() {
