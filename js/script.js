(function() {
  var app, checkWayPoints, count, initMenu, mobilecheck, onSolved, rootClassList, scrollDiff, scrollDirection, scrollPrev, setup;
  window.app = app = {};
    ...
    */
    ...
    window.requestAnimationFrame(function() {
      ...
      if (scrollDirection === "up") {
        rootClassList.add("scrolled-up");
        return rootClassList.remove("scrolled-down");
      } else if (scrollDirection === "down") {
        rootClassList.add("scrolled-down");
        return rootClassList.remove("scrolled-up");
      }
    });
    return scrollPrev = scroll;
  };
  setup = function() {
    return window.addEventListener("scroll", checkWayPoints);
  };
  count = 0;
  onSolved = function() {
    count++;
  ...
  app.initMenu = initMenu = function() {
    var trigger;
    trigger = document.querySelector('.app-menu-trigger');
    return menu_icon.addEventListener;
  };
