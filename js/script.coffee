(->
  ...
  checkWayPoints = (event) ->    
    ...
    window.requestAnimationFrame =>
      ...
      if scrollDirection is "up"
        rootClassList.add "scrolled-up"
        rootClassList.remove "scrolled-down"
      else if scrollDirection is "down"
        rootClassList.add "scrolled-down"
        rootClassList.remove "scrolled-up"
    scrollPrev = scroll
  
  setup = ->
    window.addEventListener "scroll", checkWayPoints
